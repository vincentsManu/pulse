...
pub async fn get_db(pool: &PgPool) -> eyre::Result<Stats> {
        ...
        -- median test duration
            (
                ...
                FROM (
                    ...
                    WHERE EXISTS( SELECT 1 FROM user_interaction uix WHERE ui.user_session_id = uix.user_session_id AND uix.screen_id = '0-generatereport')
        ...
        -- % completion
            (
                ...
                (
                    ...
                    WHERE screen_id = ('0-generatereport')
                ) genreport
